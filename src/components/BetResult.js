...
function BetResult(props)  {
    ...
    let style1 = {padding : '5px 10px', margin: '0px', color:'black'}
    let style2 = {padding : '10px', margin: '0px'}

    let [status, setStatus] = useState()
    let [styleBackground, setStyleBackground] = useState()
        ...
        <>
            ...
            <div>
                <Menu style={styleBackground}>
                    <p style={style1}> {status} : {props.bet.playerBet}</p>
                </Menu>
                <Test>
